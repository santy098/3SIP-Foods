...
if (isset($_POST['submit'])){
	if(!empty($_SESSION['user_info'])) {
        ...
        echo '<script type="text/javascript"> alert("'.$user_info.'")</script>';
...
<div class="page-header">
    <center><h1>Fabio Trabocchi</h1></center>
    </div>

    <form action="shopping4.php" name="orderform" method="post" onsubmit="return confirmation()">
    <div class="container">
    ...
    <footer id="site-footer" style="">
        <div class="container clearfix">
            ...
            <div class="right">
                ...
                <input type="hidden" value = "Fabio Trabocchi" name="hotel">
